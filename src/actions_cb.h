...
SetAction<uint8_t> set_action_contrast(&lcd, "Contrast", &WDY_STATE.config.screen.contrast, TYPE_UINT);
SetAction<uint8_t> set_action_backlight(&lcd, "Backlight", &WDY_STATE.config.screen.backlight, TYPE_UINT);
